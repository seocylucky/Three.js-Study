...
export default function example() {
  ...
  // 각각의 텍스처에 대해 인코딩 설정 호출
  setTextureEncoding(frontTexture);
  setTextureEncoding(rightTexture);
  setTextureEncoding(leftTexture);
  setTextureEncoding(topTexture);
  setTextureEncoding(bottomTexture);
  setTextureEncoding(backTexture);
